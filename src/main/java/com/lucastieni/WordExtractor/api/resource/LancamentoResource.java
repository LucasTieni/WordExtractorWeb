...
import com.lucastieni.WordExtractor.api.dto.AtualizaStatusDTO;
import com.lucastieni.WordExtractor.api.dto.LancamentoDTO;
...
public class LancamentoResource {
	...
	private final TUsuarioService usuarioService;
	
//	public LancamentoResource (LancamentoService service, TUsuarioService usuarioService) {
...
//	}
	...
	public ResponseEntity atualizar( @PathVariable("id") Long id, @RequestBody LancamentoDTO dto) {
		...
		}).orElseGet( () -> new ResponseEntity("Lancamento não encotrado na base de dados.", HttpStatus.BAD_REQUEST));
	}
